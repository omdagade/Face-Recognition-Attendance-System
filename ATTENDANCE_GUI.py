...
def start_GUI():
    ...
    def add_student():
        ...
        submit_button = tk.Button(new_window, text="Add Student", command=lambda: on_submit(textbox1.get().lower(), textbox2.get().lower(), textbox3.get().lower(), textbox4.get().lower(), textbox5.get().lower()))
    ...
    def on_submit(value1,value2,value3,value4,value5):
        ...
        if(value1!="Enter Id" and value5!="Enter Parents Email" and value2!="Enter Name" and value3!="Enter Branch" and value4!="Enter Year" and re.match(pattern1, value5)):
            directory = value1
